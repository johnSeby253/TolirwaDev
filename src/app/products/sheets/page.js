...
import { SHEETS_CONTENT } from "@/lib/ApiPath";
  ...
  return (
    <div className="flex justify-center w-full mb-8">
      <div className="w-full max-w-5xl px-5">
        <h1 className="text-gray-600 text-3xl font-bold mt-8 mb-7">{sheets.title}</h1>
